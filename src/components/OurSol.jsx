...
export default function OurSol() {
  return (
    <div className="px-4 lg:px-44 mt-7 h-[650px] md:h-[550px]">
      <h1 className="flex justify-center md:justify-end text-3xl md:text-5xl font-bold text-[#043873]">Our Solution</h1>
